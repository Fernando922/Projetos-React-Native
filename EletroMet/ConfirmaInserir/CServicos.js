...
class CServicos extends Component{
            ...
            return(
                  <ImageBackground source={require('../imagens/scroll.jpg')} style={styles.fundo}>
                        <View style={styles.confirmaContainer}>
                              ...
                              <Text style={styles.textoConfirma}>Serviços</Text>
                              
                              <View style={styles.linhaConfirma}>
                                    <Image source={require('../icones/servico.png')} style={styles.iconesConfirma}/>
                              </View>
                              ...
                              <View style={styles.confirma}>
                                    ...
                                    <TouchableOpacity onPress={() => {this.props.adicionar(4,'Serviços'),this.props.navigation.navigate('Menu')}}>
...
export default connect(mapStateToProps, mapDispatchToProps )(CServicos)
